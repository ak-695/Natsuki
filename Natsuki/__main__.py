...
buttons = [
    [
        InlineKeyboardButton(
            text="Nicky News 🙋‍♂️", url="https://t.me/Nicky_Updates"
        ),
        InlineKeyboardButton(
            text="Support Group 💬", url="https://t.me/Nicky_Updates"
        ),
    ],
    [
        InlineKeyboardButton(
            text="Source 🗒", url="Github.com/ak-695"
        ),
        InlineKeyboardButton(
    ...
    [
        InlineKeyboardButton(
            ...
            url="t.me/TheNickybot?startgroup=true",
        ),
    ],
]
...
def Natsuki_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            text=f"* Hi There  The name's {dispatcher.bot.first_name} \n\nAs  You I'm a next generational group management bot developed by Nicky Updates.* "
            f"\n\n Join [NatsukiUpdates](https://t.me/Nicky_Updates) To Keep Yourself Updated About {dispatcher.bot.first_name}"
        ...
        query.message.edit_text(
            ...
            f"\n\nYou Can get support {dispatcher.bot.first_name} by joining [Nicky Support](https://t.me/Nicky_Updates).\n"
            f"",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
        ...
        query.message.edit_text(
            ...
            f"\n\nBased on [SDBOTsInifinity](https://t.me/Nicky_Updates)."
